<!DOCTYPE html>
<html lang="en-US" style="background: url('../img/newbg_alt.jpg') top center;background-size:cover;background-attachment: fixed;
...
<head>
    ...
    <link href="lt-styles.css" rel="stylesheet">
    ...
    <div class="choose-outer">
        <div class="container">
            <div class="choose-wrap">
                ...
                <!-- <h1 class="center animated fadeInDown">Unlock The Romantic Secrets Of Your Past, Present And Future</h1> -->
                <h1 class="baskerville center animated fadeInDown" style="max-width:900px;">Unlock The Hidden Truth About Your Future Together</h1>
                <h2 class="center animated fadeInUp">Draw 3 Cards And Read Them In Just 10 Seconds...</h2>
                    ...
                    <div class="remodal" data-remodal-id="getreading" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
                        ...
                        <div>
                            ...
                            <div class="form-group form_inner fname-inner no-inline">
                                <div class="form-col fname">
                                    <form id="reading-form" action="result/one" method="POST">
                                        ...
                                        <p class="left">My Partners Name Is:</p>
                            ...
                            <div class="form-group send">
                                <button class="btn btn-purple multiple up btnsubmit" type="button">Reveal My Past, Present, and Future </button>
                    ...
                    <div class="animated fadeInUp">
                        <div class="cards-row-wrap" data-cis="3">
                            <div class="cards-row-outer">
                                <div id="cards-row-1" class="cards-row clearfix" data-cisr="3">
                        ...
                        <div class="instructions ">
                            ...
                            <div class="reshuffle-info" style="background: inherit; color: #fff; font-size: 18px;">
                                    Shuffle The Deck
                                </div>
                                <div class=""><a href="javascript:void(0)" class="btn btn-sm btn-default btn-plain btn-shuffle">Shuffle</a>
                                </div>
                            ...
                            <div class="alert alert-warning text-begin text-center text-shadow-minimal clearfix" style="background: inherit !important; color: #fff; font-size: 18px !important;">
                        ...
                        <div class="col-xs-10 col-xs-offset-1 col-sm-4 col-sm-offset-4 get-my-reading-wrap">
                            <div class="get-my-reading collapse">
                                <a href="#getreading" id="getreading" class="btn btn-primary btn-block btn-lg btn-get-reading">Get My Reading!</a>
                            </div>
                        </div>
                    </div>
        ...
        <footer>
            ...
            <script src="js/custom-scripts.js?v=3b"></script>
