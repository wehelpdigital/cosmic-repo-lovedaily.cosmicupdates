        ...
        var init = function() {
            ...
            btn_shuffle.click(function() {
                if (!$(this).hasClass('shuffling')) // if shuffling not in progress
                {
                    ...
                    instructions.find('.reshuffle-info').fadeOut().html('&nbsp;<br class="visible-xs"><span class="text-shadow-minimal lt-orange italic">... shuffling ...</span>').fadeIn().fadeOut().fadeIn().fadeOut().fadeIn();

                    // card shufelling animation
                    reshuffleCard(card_rows.first().find('.card').css('position','absolute'), 0, options.animate.call()); 
        ...
        var reshuffleCard = function(cards, i, animate) {
            if (animate && i < options.shuffles && i < cards.length) {
                ...
                setTimeout(function() {
                    ...
                    instructions.find('.reshuffle-info').fadeOut().html('&nbsp;<br class="visible-xs"><span class="text-shadow-minimal">All Done!</span><br class="visible-xs">').css('color','#00A65A').fadeIn();
