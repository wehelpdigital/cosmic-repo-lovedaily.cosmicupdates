...
<html lang="en-US" style="background-color: #000;">
    ...
    <script src="https://www.googleoptimize.com/optimize.js?id=OPT-52PFVFT"></script>
    <style>
        .async-hide {
            opacity: 0 !important
        }
   ...
   <!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    gtag('config', 'G-H0Z8R2996L'); 
        ...
        <!-- <script type="text/javascript">
            ...
            //http://numerology.loveread.hop.clickbank.net?email=83&savedreading=true&g=male http://numerology.loveread.hop.clickbank.net/?mail=gowebdevhero@gmail.com&savedreading=true&g=male

            jQuery(document).ready(function() { 
                
                <?php 
                    
                    if(isset($_GET['savedreading']) && $_GET['savedreading']=="true") {

                        ?>

                        window.location.href = "https://readyourlover.com/result/m?id=<?php echo $_GET['id']; ?>&hop=<?php echo $_GET['hop']; ?>";
                        
                        <?php  
                        
                    } else if(isset($_GET['savedsp']) && $_GET['savedsp']=="true") {

                        ?>

                        window.location.href = "https://readyourlover.com/result/ssalespage?id=<?php echo $_GET['id']; ?>&hop=<?php echo $_GET['hop']; ?>";
        ...
        <link href="new/responsive.css" rel="stylesheet">
        <link href="new/style-cards.css" rel="stylesheet">
        ...
        <title>Get Your FREE Love Reading - EXTREMELY Accurate!</title>
    ...
    <body>
            ...
            <div class="container-upper center" id="container-upper">
                ...
                <div class="container" style="padding-bottom:190px;">
                    ...
                    <div class="choose-wrap"> 
                        ...
                        <div class="remodal" data-remodal-id="getreading">
                                ...
                                <div class="form-group">
                                    <div class="form-col fname">
                                        ...
                                        <?php
                                            ...
                                            if (isset($_GET['hop'])) { $hopvalue = "?hop=" . $_GET['hop']; }
                                        ?>
                                        <?php
                                            $tid = "&tid=default";
                                            if (isset($_GET['tid'])) { $tid = "&tid=" . $_GET['tid']; }
                                        ?>
                                        ...
                                        <form id="reading-form" action="result/one" method="POST">
                                            ...
                                            <!-- Page Identifier -->
                                            <input type="hidden" name="pageIdentifier" value="2" />
                                            ...
                                            <p class="left" style="margin-top:20px; text-align:left;">My Partners Name Is:</p>

                                            <input name="inputPartnersName" class="form-control on-focus" id="firstNameT" placeholder="Enter Your Partners First Name" />

                                            <div class="form-group send">
                                                <button class="btn btn-purple multiple up btnsubmit" type="submit">Reveal My Past, Present, and Future</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-9 text-center guide-wrap">
                                            <div class="guide nice-box collapse">
                                                <p class="text-shadow-minimal">
                                                    ...
                                                    <b>Select Card One</b>: What They Think About You
                                                </p>
                                            </div>
                                        </div>
            ...
            <div class="container-bottom" id="love-reading">
                ...
                <div class="container-button" style="margin:50px auto;">
                    ...
                    <div class="button">
                        ...
                        <a href="https://lovedaily.cosmicupdates.com/daily.php#container-upper" class="btn btn-sm btn-default btn-plain" style="">TELL ME EVERYTHING!</a>
        ...
        <footer>
            ...
            <script src="new/js/script-cards.js"></script>
            <script src="new/js/yii.js"></script>
            <script src='new/js/rbeix.js'></script>
            <script src="new/js/index.js"></script>
            <script src="new/js/bootstrap.min.js"></script>
            <script src="new/js/custom-scripts-two.js?v=3b"></script>
            <script src="new/js/bootstrap-switch.js"></script>
            <script src="https://apis.google.com/js/platform.js"></script>
            <script src="new/js/bootstrap-datepicker.js"></script>
            <script src="https://chancejs.com/chance.min.js"></script>
            <!-- remodal-->
            <link rel="stylesheet" href="new/remodal-new/remodal.css">
            <link rel="stylesheet" href="new/remodal-new/remodal-default-theme.css">
            <script src="new/remodal-new/remodal.js"></script>
            ...
            <script type="text/javascript">
                ...
                $('.btnsubmit').click(function() {
                    ...
                    if ($('#firstNameT').val() == "") {
                        ...
                        gtag('event', 'new_landing_page_layout_1_a_clicked', {
                            'event_category': 'button',
                            'event_label': 'clicked',
                            'value': 'reading'
                        });

                        gtag('event', 'new_landing_page_layout_1_a_variant_a_violet', {
                            'event_category': 'button',
                            'event_label': 'clicked',
                            'value': 'reading',
